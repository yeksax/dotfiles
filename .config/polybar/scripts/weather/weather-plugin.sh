...
COLOR_CLOUD="#F0F0F0"
COLOR_THUNDER="#F0F0F0"
COLOR_LIGHT_RAIN="#f0f0f0"
COLOR_HEAVY_RAIN="#f0f0f0"
COLOR_SNOW="#f0f0f0"
COLOR_FOG="#f0f0f0"
COLOR_TORNADO="#f0f0f0"
COLOR_SUN="#f0f0f0"
COLOR_MOON="#f0f0f0"
COLOR_ERR="#f0f0f0"
COLOR_WIND="#f0f0f0"
...
function outputCompact {
    ...
    OUTPUT="$WIND %{T$WEATHER_FONT_CODE}%{F$ICON_COLOR}$ICON%{F-}%{T-} $ERR_MSG$COLOR_TEXT_BEGIN$DESCRIPTION$COLOR_TEXT_END"
